<div class="hcart">
    ...
    <div class="dropdown">
        ...
        <ul class="hcart-list">
            <li>
                <a href="producto.php" class="fig pull-left"><img src="images/bomba_contreto_kcp_2_thumb.jpg" alt=""></a>
                <div class="block">
            ...
            <li>
                <a href="producto.php" class="fig pull-left"><img src="images/cargador_john_deere_thumb.jpg" alt=""></a>
                <div class="block">
            ...
            <li>
                <a href="producto.php" class="fig pull-left"><img src="images/minicargador-caterpillar-216b_thumb.jpg" alt=""></a>
                <div class="block">
