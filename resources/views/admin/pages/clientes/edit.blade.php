    ...
    <div class="row bg_blanco"> 
        ...
        <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-3">
                ...
                {{Form::text('name', $cliente->name, ['class'=>'form-control','placeholder'=>'Ej. example@promin.mx'])}}
                @if ($errors->has('name'))
                    <span class="help-block">
              ...
              <div class="col-xs-12 col-sm-12 col-md-3">
                ...
                {{Form::text('last_name', $cliente->last_name, ['class'=>'form-control','placeholder'=>'Ej. example@promin.mx'])}}
              ...
              <div class="col-xs-12 col-sm-12 col-md-3">
                ...
                {{Form::text('parental_name', $cliente->parental_name, ['class'=>'form-control','placeholder'=>'Ej. example@promin.mx'])}}
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-3">
            ...
            {{Form::text('email2', $cliente->email2, ['class'=>'form-control','placeholder'=>'Ej. example@promin.mx'])}}
          ...
          <div class="col-xs-12 col-sm-12 col-md-3">
            ...
            {{Form::text('website', $cliente->web, ['name'=>'web','class'=>'form-control','placeholder'=>'Ej. example@promin.mx'])}}
            @if ($errors->has('web'))
                    <span class="help-block">
