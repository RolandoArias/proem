...
<div class="container-fluid home-section home-section-prod nopad"    >
	<div class="container pro1-inner con-prod-desk">
		<div class="col-sm-6 pro1-inner-1 animated">
			<img src="/assets_pro/img/prologo3pro.png" width="100%">
		</div>
		<div class="col-sm-5 pro1-inner-2 text-center animated zoomIn con-pro-bgi">
			<p class="pro-img col-sm-8">
				<img src="/assets_pro/img/prologo3.png">
			</p>
			...
			<p class="col-sm-8 subpro animated fadeIn">500g</p>
			<p class="col-sm-8 subpro animated fadeIn">520g</p>
			<p class="col-sm-8 subpro animated fadeIn">680g</p>
			<p class="col-sm-8 subpro con-subdesk animated fadeIn leyend">Búscanos en tu tienda favorita</p>
	...
	<div id="myCarousel" class="carousel slide col-sm-12" data-ride="carousel">
			  <!-- Wrapper for slides -->
                ...
                <img class="soso animated zoomIn" id="con-juega-prod" src="{{ asset('assets_pro/img/hometitlesoso.png')}}" alt="" width="100%" />
					   <img class="con-prod-carr animated zoomInDown" src="/assets_pro/img/prologo3pro.png" width="100%">
					</div>
			...
			<p class="col-sm-8 subpro con-subtitle animated fadeIn">500g</p>
			<p class="col-sm-8 subpro con-subtitle animated fadeIn">520g</p>
			<p class="col-sm-8 subpro con-subtitle animated fadeIn">680g</p>
			<p class="col-sm-8 subpro con-subfoot animated fadeIn leyend">Búscanos en tu tienda favorita</p>
					</div>
                    </div>
