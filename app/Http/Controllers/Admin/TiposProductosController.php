...
class TiposProductosController extends Controller
{
    ...
    {  
        ...
        return view('admin.pages.tipos-productos.index')->with(['lineas'=>$lineas]);
    ...
    public function create()
    {
        ...
        return view('admin.pages.tipos-productos.new');
    }
    ...
    public function edit($id)
    {
        ...
        if($linea){
            ...
            return view('admin.pages.tipos-productos.edit')->with(['linea'=>$linea, 'type'=>$type]);
        }
        return var_dump('404');
    }
